                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
							...
							<c:otherwise>
							<li><h2 class="h2_right"><a href="/Project/member/myPage.mem">${id }님 반갑습니다</a></h2></li>
                            ...
                            <c:if test="${id == 'admin' }">
							<li><a href="/SJshop/main.jsp"><font color="red">메인메뉴 가기</font></a></li>
							</c:if>
							</c:otherwise>
							</c:choose>
                        </ul>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="/Project/main.jsp">Home</a></li>
                        <li><a href="../admin/memberList.mem">회원관리</a></li>
                        <li><a href="itemList.item">상품목록</a></li>
                        <li><a href="itemInsert.jsp">상품등록</a></li>
                        <li><a href="itemStockView.item">재고현황</a></li>
                        <li><a href="../admin/OrderList.ord">주문목록</a></li>
                    </ul>
                </div>  
            </div>
        </div>
