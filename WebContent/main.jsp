    ...
    <div class="slider-area">
			...
			<div class="block-slider block-slider4">
				<ul class="" id="bxslider-home4">
					<li>
						<img src="image/banner/mainboardbanner.png" width="100px" height="350px" alt="Slide">
					</li>
					<li><img src="image/banner/mainboardbanner1.png" alt="Slide"></li>
					<li><img src="image/banner/intel slide.png" alt="Slide"></li>
				</ul>
			</div>
			<!-- ./Slider -->
    </div> <!-- End slider area -->
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2019 영남기술교육원. All Rights Reserved. <a href="#" target="_blank">JS Shop.com</a></p>
                    </div>
                </div>
