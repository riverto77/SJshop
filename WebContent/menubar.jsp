                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                        	<c:choose>
							<c:when test="${id == null }">
							<li><a href="/SJshop/member/loginForm.jsp"><i class="fa fa-user"></i> 로그인</a></li>
							<li><a href="/SJshop/member/joinForm.jsp"><i class="fa fa-user"></i> 회원가입</a></li>
							</c:when>
							<c:otherwise>
							<li><h2 class="h2_right"><a href="/SJshop/member/myPage.mem">${id }님 반갑습니다</a></h2></li>
                            <li><a href="/SJshop/member/myPage.mem"><i class="fa fa-user"></i>마이페이지</a></li>
                            <li><a href="/SJshop/order/orderMyOrder.ord"><i class="fa fa-user"></i> 내 주문 목록</a></li>
                            <li> <a href="/SJshop/item/cartList.item"><i class="fa fa-user"></i> 장바구니</a></li>
                          	<li><a href="/SJshop/logout.log"><i class="fa fa-user"></i> 로그아웃</a></li>
                            <c:if test="${id == 'admin' }">
							<li><a href="/SJshop/admin/admin_menu.jsp"><font color="red">관리자메뉴</font></a></li>
							</c:if>
							</c:otherwise>
							</c:choose>
                        </ul>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="/SJshop/main.jsp"><img class="logoimage" src="/SJshop/image/main/logo.png"></a></h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="/SJshop/main.jsp">Home</a></li>
                        <li><a href="/SJshop/item/cpu.item?category=cpu">CPU</a></li>
                        <li><a href="/SJshop/item/mainboard.item?category=mainboard">메인보드</a></li>
                        <li><a href="/SJshop/item/vga.item?category=vga">그래픽카드</a></li>
                        <li><a href="/SJshop/item/memory.item?category=memory">메모리</a></li>
                        <li><a href="/SJshop/item/power.item?category=power">파워</a></li>
                        <li><a href="/SJshop/item/ssd.item?category=ssd">SSD</a></li>
                        <li><a href="/SJshop/item/case.item?category=case">케이스</a></li>
                    </ul>
                </div>  
            </div>
        </div>
