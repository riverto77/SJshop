...
public class CpuListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// TODO Auto-generated method stub
			...
			ArrayList<Item> cpuList = new ArrayList<Item>();
			int page = 1;
			int limit = 8;
			int limitPage = 8;
			...
			//총 리스트 수를 받아옴
			cpuList = itemListService.getCategoryItemList(page, limitPage, select, search, category);
			//리스트를 받아옴
			//총 페이지 수
