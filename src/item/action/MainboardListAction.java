...
public class MainboardListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ArrayList<Item> mainboardList = new ArrayList<Item>();
		int page = 1;
		int limit = 8;
		int limitPage = 8;
		...
		// 총 리스트 수를 받아옴
		mainboardList = itemListService.getCategoryItemList(page, limitPage, select, search, category);
		// 리스트를 받아옴
		// 총 페이지 수
		...
		forward.setPath("../item/mainboard.jsp");
		return forward;
